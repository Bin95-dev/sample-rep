                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <div class="dropzone required" input="#ctrl-picture" fieldname="picture"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                <input name="picture" id="ctrl-picture" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('picture',""); ?>" type="text"  />
