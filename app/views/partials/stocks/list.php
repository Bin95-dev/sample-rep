...
$can_add = ACL::is_allowed("stocks/add");
$can_edit = ACL::is_allowed("stocks/edit");
$can_view = ACL::is_allowed("stocks/view");
$can_delete = ACL::is_allowed("stocks/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Stocks</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("stocks/add") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('stocks'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('stocks'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Allocation"> Allocation</th>
                                                <th  class="td-Province"> Province</th>
                                                <th  class="td-FUND_SOURCE"> Fund Source</th>
                                                <th  class="td-date_inputed"> Date Inputed</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-Allocation">
                                                    <span <?php if($can_edit){ ?> data-value="<?php echo $data['Allocation']; ?>" 
                                                        data-name="Allocation" 
                                                        data-title="Enter Allocation" 
                                                        data-placement="left" 
                                                        data-toggle="click" 
                                                        data-type="number" 
                                                        data-mode="popover" 
                                                ...
                                                <td class="td-date_inputed"> <?php echo $data['date_inputed']; ?></td>
